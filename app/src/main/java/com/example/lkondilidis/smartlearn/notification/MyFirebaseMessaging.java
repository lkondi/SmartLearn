...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendMyNotification(RemoteMessage remoteMessage){
        ...
        MyNotification mNotification = new MyNotification(this);
        Notification.Builder builder = mNotification.getOreoNotification(title, body, pendingIntent,
                defaultSound, icon);
        ...
        mNotification.getManager().notify(i, builder.build());
