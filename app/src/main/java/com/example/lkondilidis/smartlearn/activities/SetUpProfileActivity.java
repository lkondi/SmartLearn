...
public class SetUpProfileActivity extends AppCompatActivity {
    private final AppCompatActivity activity = SetUpProfileActivity.this;
    ...
    private void initViews() {
        ...
        if (!STRING_EMPTY.equals(currentuser.getPlan())) {
            ...
            Toast.makeText(SetUpProfileActivity.this, "Please fill you personal data",
    ...
    private void isTutor() {
        if (((CheckBox) tutorcheck).isChecked()) {
            ...
            Toast.makeText(SetUpProfileActivity.this, "You are a tutor!",
                    Toast.LENGTH_LONG).show();
        }
        else {
            ...
            Toast.makeText(SetUpProfileActivity.this, "You are a student!",
                    Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void updateUser() {
        ...
        System.out.println(planfinal);
            ...
            if (!STRING_EMPTY.equals(editTextStudies.getText().toString())
                ...
                submitClicked();
                Toast.makeText(SetUpProfileActivity.this, "EDITED!",
                        Toast.LENGTH_LONG).show();


            } else {
                Toast.makeText(SetUpProfileActivity.this, "One or more fields left empty!",
                        Toast.LENGTH_LONG).show();
            }
